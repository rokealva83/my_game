...
class MyFactoryAdmin(admin.ModelAdmin):
    ...
    # ordering = ['production_class', 'id']
    # list_editable = ['time_production', 'factory_size', 'factory_mass', 'power_consumption',
    #                  'price_internal_currency', 'price_construction_material', 'price_chemical',
