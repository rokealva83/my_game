...
class BasicFactory(models.Model):
    ...
    factory_name = models.CharField(max_length=50, verbose_name=u'Название', default='Завод ""')
    description = models.CharField(max_length=500, verbose_name=u'Описание', default='Завод по производству ')
    ...
    price_expert_deployment = models.IntegerField(default=0, verbose_name=u'Количество сотрудников')
    assembly_workpiece = models.IntegerField(default=0, verbose_name=u'Время создания заготовки')
    time_deployment = models.IntegerField(default=0, verbose_name=u'Время развертывания')
    ...
    time_production = models.IntegerField(default=0, verbose_name=u'Время производства')
    factory_size = models.IntegerField(default=0, verbose_name=u'Размер')
    factory_mass = models.IntegerField(default=0, verbose_name=u'Вес')
