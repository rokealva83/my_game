...
class UserVariables(models.Model):
    ...
    registr_resource1 = models.IntegerField(verbose_name=u'Никель при регистраци')
    registr_resource2 = models.IntegerField(verbose_name=u'Железо при регистраци')
    registr_resource3 = models.IntegerField(verbose_name=u'Медь при регистраци')
    registr_resource4 = models.IntegerField(verbose_name=u'Алюминий при регистраци')
    registr_mineral1 = models.IntegerField(verbose_name=u'Вариарит при регистраци')
    registr_mineral2 = models.IntegerField(verbose_name=u'Иннэлит при регистраци')
    registr_mineral3 = models.IntegerField(verbose_name=u'Ренниит при регистраци')
    registr_mineral4 = models.IntegerField(verbose_name=u'Кобальт при регистраци')
