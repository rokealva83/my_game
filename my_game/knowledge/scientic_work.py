...
def scien_up(*args):
    ...
    if number_scientic < 3:
        ...
        if level_up == 1:
            ...
            cost_study_internal_currency = int(scien.price_internal_currency)
            cost_study_resource1 = int(scien.price_resource1)
            cost_study_resource2 = int(scien.price_resource2)
            cost_study_resource3 = int(scien.price_resource3)
            cost_study_resource4 = int(scien.price_resource4)
            cost_study_mineral1 = int(scien.price_mineral1)
            cost_study_mineral2 = int(scien.price_mineral2)
            cost_study_mineral3 = int(scien.price_mineral3)
            cost_study_mineral4 = int(scien.price_mineral4)
        else:
            time_study_turn = int(time_studys * int(math.exp(level_up) / 5))
            cost_study_internal_currency = int(scien.price_internal_currency * math.exp(level_up) / 5)
            cost_study_resource1 = int(scien.price_resource1 * math.exp(level_up) / 5)
            cost_study_resource2 = int(scien.price_resource2 * math.exp(level_up) / 5)
            cost_study_resource3 = int(scien.price_resource3 * math.exp(level_up) / 5)
            cost_study_resource4 = int(scien.price_resource4 * math.exp(level_up) / 5)
            cost_study_mineral1 = int(scien.price_mineral1 * math.exp(level_up) / 5)
            cost_study_mineral2 = int(scien.price_mineral2 * math.exp(level_up) / 5)
            cost_study_mineral3 = int(scien.price_mineral3 * math.exp(level_up) / 5)
            cost_study_mineral4 = int(scien.price_mineral4 * math.exp(level_up) / 5)
