...
def action_modificate_ship(request):
    ...
    new_ship_elements = ElementShip.objects.filter(project_ship=new_ship_id)
    ...
    for new_ship_element in new_ship_elements:
        ...
        ship = Ship.objects.filter(place_id=session_user_city, project_ship=modificate_ship_project).update(
